...
results <- subset(results, results$Scenario <= n) # Minor problem with extra runs.
...
Membership in the $c_i$ group occurs at an average `r paste0(prev.grp, collapse=", ")` probability.
