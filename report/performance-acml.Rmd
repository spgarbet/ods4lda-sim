...
The code being tested is available in the git commit hash `a7215f0d908230f050cf06f40d258425ff437a2f`.
...
inits.sim            <- rbind(c(75, -1, -.5, -2, -.5, log(9),log(1.25),0,log(3.5)),
                              ...
                              c(75, -1, -.5, -2, -.5, log(9),log(0.5),0,log(3.5)),
                              c(75, -2.5, -.5, -2, -1.25, log(9),log(1.25),0,log(3.5)),
...
hn_scale=c(1.5, 2, 0.5, 0.1, 1.5, 2, 0.5, 0.1)
```
