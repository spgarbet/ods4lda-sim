...
scenarios <- rbind(c(75, -1, -1, -1, 1, log(9),log(1),0,log(3.5)),
...
The code being tested is available in the git commit hash `48e27ff1f95c37f83f35ea0e022dc4a71c371061`.

### Method
1600 individuals were simulated using 4 mixed effect models,

$$y_{ij} = 75 - 1 t_{ij} - 1 g_i - R_k c_i + t_{ij} g_i  + b_{0i} + b_{1i} t_{ij} + \epsilon_{ij}$$
$$\begin{bmatrix} b_{0i} \\ b_{1i} \\ \end{bmatrix} \sim \mathcal{N}\left(
  \begin{bmatrix} 0\\0\\ \end{bmatrix},
  \begin{bmatrix} S_k & 0 \\ 0 & 1 \\ \end{bmatrix} \right)$$
